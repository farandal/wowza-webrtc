 ...
 */
 ...
 class WowzaPeerConnectionPlay {
   ...
   public set = (props: IProps) => {
     if (props.sdpURL != null) this.sdpURL = props.sdpURL;
     if (props.videoElement != null) this.videoElement = props.videoElement;
 
     if (props.streamInfo != null) this.streamInfo = props.streamInfo;
     if (props.userData != null) this.userData = props.userData;
 
     if (props.mungeSDP != null) this.mungeSDP = props.mungeSDP;
 
     if (props.onconnectionstatechange != null) this.onconnectionstatechange = props.onconnectionstatechange;
     if (props.onstop != null) this.onstop = props.onstop;
     if (props.onerror != null) this.onerror = props.onerror;
   };
   ...
   start() {
     ...
     if (this.peerConnection == null) {
       console.log(
         'WowzaPeerConnectionPlay.start: sdpURL:' + this.sdpURL + ' streamInfo:' + JSON.stringify(this.streamInfo)
       );
