...
export const mungeSDPPublish = (sdpStr, mungeData) => {
                                ...
                                if (mungeData.videoBitrate != undefined) {
                                    sdpStrRet +=
                                        '\r\na=fmtp:' +
                                            ...
                                            mungeData.videoBitrate +
                                            ';x-google-max-bitrate=' +
                                            mungeData.videoBitrate;
                                }
                            }
                            if ('opus'.localeCompare(match) == 0 ||
    ...
    console.error(mungeData.videoCodec);
    console.error(sdpStrRet);
    return sdpStrRet;
};
export const mungeSDPPlay = (sdpStr) => {
    let sdpLines = sdpStr.split(/\r\n/);
    let sdpStrRet = '';
...
//# sourceMappingURL=WowzaMungeSDP.js.map