...
const set = (props) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        let s1 = yield setState(newState);
        if (s1.stream == null) {
            yield getUserMedia();
        }
        let s2 = yield getDevices();
        if (constraintsChanged && s2.stream != null) {
            yield applyConstraints(s2.stream, s2.constraints);
        }
        return getState();
    }
    catch (e) {
...
const getUserMedia = (mediaKind) => {
    ...
    return new Promise((resolve, reject) => {
        ...
        const getUserMediaSuccess = (stream) => __awaiter(void 0, void 0, void 0, function* () {
...
const getDevices = () => {
    return new Promise((resolve, reject) => {
        ...
        navigator.mediaDevices.enumerateDevices().then((devices) => __awaiter(void 0, void 0, void 0, function* () {
            console.log(JSON.stringify(devices));
            let constraints = Object.assign({}, getState().constraints);
            let cameras = [];
            let microphones = [];
            ...
            let newState = yield setState(newStateUpdate);
            resolve(newState);
        })).catch((e) => {
...
const setCamera = (id) => {
    ...
    if (id === 'screen') {
        ...
        let constraints = Object.assign({}, state.constraints);
