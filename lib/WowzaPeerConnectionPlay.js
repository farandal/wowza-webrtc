    ...
    constructor(props) {
        ...
        this.gotDescription = (description) => {
            ...
            this.peerConnection
                ...
                _this.wsConnection.send('{"direction":"play", "command":"sendResponse", "streamInfo":' +
        ...
        this.wsConnect = (url) => {
            ...
            function sendPlayGetOffer() {
                ...
                _this.wsConnection.send('{"direction":"play", "command":"getOffer", "streamInfo":' +
                    JSON.stringify(_this.streamInfo) +
                    ', "userData":' +
                    JSON.stringify(_this.userData) +
                    '}');
            ...
            function sendPlayGetAvailableStreams() {
                ...
                _this.wsConnection.send('{"direction":"play", "command":"getAvailableStreams", "streamInfo":' +
                    JSON.stringify(_this.streamInfo) +
                    ', "userData":' +
                    JSON.stringify(_this.userData) +
                    '}');
...
//# sourceMappingURL=WowzaPeerConnectionPlay.js.map